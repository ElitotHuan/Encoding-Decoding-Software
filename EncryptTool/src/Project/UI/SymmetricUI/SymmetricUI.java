...
public class SymmetricUI extends JFrame implements ActionListener {
    ...
    public SymmetricUI() throws NoSuchAlgorithmException {
        ...
        master.setBorder((BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "JAVA SYMMETRIC",
                center, TitledBorder.TOP)));
        ...
        p8 = new JPanel();
        p8.setBorder((BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Message",
                center, TitledBorder.TOP)));

        p9 = new JPanel();
        p9.setLayout(new BoxLayout(p9, BoxLayout.Y_AXIS));
        p9.setBorder((BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "File",
                center, TitledBorder.TOP)));
...
//        setDefaultCloseOperation(EXIT_ON_CLOSE);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equalsIgnoreCase("Encrypt")) {
            ...
            } catch (NoSuchPaddingException | NoSuchAlgorithmException | InvalidKeyException | IllegalBlockSizeException | BadPaddingException
                    | IOException | InvalidAlgorithmParameterException | NoSuchProviderException ex) {
                ex.printStackTrace();
            }
        }
