...
public class ASymmetricUI extends JFrame implements ActionListener {
    ...
    JPanel p1 , p2 , p3;
    JLabel keySize , publicKey , privateKey , message , file, encryptMessage , decryptMessage, messageHybrid , encodedHybrid  , decodedHybrid
            , encryptFilePath , decryptFilePath , modes , symmetric , secretKey , symmetricMode , symmetricPadding , symmetricAlgo ;
    ...
    JButton generateButton ,secretKeyGen, openFile , openHybridFile,
            encryptButton , decryptButton , encryptFileButton , decryptFileButton , encryptHybrid , decryptHybrid , encryptHybridFile , decryptHybridFile;
    ...
    public class RSATab extends JPanel{
        public RSATab(){
            ...
            insertFileMessagePanel.setBorder(new CompoundBorder(new TitledBorder("Insert"), new EmptyBorder(4, 4, 4, 4)));
            add(insertFileMessagePanel, gbc);

            gbc.gridy +=2;
            Options options = new Options();
            options.setBorder(new CompoundBorder(new TitledBorder("Options"),
                    new EmptyBorder(4, 4, 4, 4)));
            add(options, gbc);

            gbc.gridy +=2;
            Encrypt_Decrypt encrypt_decrypt = new Encrypt_Decrypt();
            encrypt_decrypt.setBorder(new CompoundBorder(new TitledBorder("Encrypt_Decrypt"),
                    new EmptyBorder(4, 4, 4, 4)));
            ...
            f.setBorder(new CompoundBorder(new TitledBorder("Encrypt_Decrypt File"),
                    new EmptyBorder(4, 4, 4, 4)));
            add(f, gbc);
        }
    }
    ...
    public class HybridTab extends  JPanel {
        public HybridTab(){
            ...
            encrypt_decryptHybrid.setBorder(new CompoundBorder(new TitledBorder("Message"), new EmptyBorder(4, 4, 4, 4)));
            add(encrypt_decryptHybrid, gbc);
            gbc.gridy++;

            Encrypt_DecryptHybridFile encryptDecryptHybridFile = new Encrypt_DecryptHybridFile();
            encryptDecryptHybridFile.setBorder(new CompoundBorder(new TitledBorder("File"), new EmptyBorder(4, 4, 4, 4)));
    ...
    public class FormPane extends JPanel {
        public FormPane(){
            ...
            secretKeyPanel.setBorder(new CompoundBorder(new TitledBorder("Key Symmetric"),
                    new EmptyBorder(4, 4, 4, 4)));
            ...
            generate.setBorder(new CompoundBorder(new TitledBorder("Key Pair"),
                    new EmptyBorder(4, 4, 4, 4)));
            add(generate, gbc);
    ...
    public class Encrypt_DecryptHybrid extends  JPanel implements  ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getActionCommand().equalsIgnoreCase("Decrypt")){
                ...
                } catch (IllegalBlockSizeException | BadPaddingException | NoSuchPaddingException | InvalidKeyException |
            ...
            if (e.getActionCommand().equalsIgnoreCase("Encrypt")) {
                ...
                try {
                    ...
                    txtHybridEncryptFile.setText(encryptFile.getAbsolutePath());
                        ...
                        | IllegalBlockSizeException | BadPaddingException | InvalidKeyException | IOException | InvalidAlgorithmParameterException ex) {
                    ex.printStackTrace();
                }
            }
        ...
        public void actionPerformed(ActionEvent e)  {
            if (e.getActionCommand().equalsIgnoreCase("Generate")){
                ...
                try {
                    ...
                    txtPrivate.setText(aSymmetric.convertBinary(aSymmetric.getGenerate().getPrivateKey().getEncoded()));
                    txtPublic.setText(aSymmetric.convertBinary(aSymmetric.getGenerate().getPublicKey().getEncoded()));
